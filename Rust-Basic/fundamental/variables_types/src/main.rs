...
fn demo_other_simple_types() {
    ...
    println!("\nHey you with the middle initial {}, your fav emoji is {}", middle_initial, favourite_emoji);
} 
...
fn demo_additional_techniques() {
    ...
    // Rust lets you redeclare a variable in the current scope. This is called shadowing and it's quite cool.
    let num = "12345";
